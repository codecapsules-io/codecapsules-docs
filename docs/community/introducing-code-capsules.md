...
description: >-
  A South African PaaS provider aimed at giving African developers better
  convenience when its time to deploy their applications.
---

# Introducing Code Capsules

![Introducing Code Capsules](../../.gitbook/assets/introducing-code-capsules.png)
...
![Deploying Frontend Capsule](../../.gitbook/assets/creating-frontend-capsule-2.gif)
...
![Frontend Capsule Build Logs](../../.gitbook/assets/frontend-capsule-build-logs-1.gif)
...
![React Frontend Capsule](../../.gitbook/assets/react-frontend-capsule.png)

## Deploying a Backend App

![Creating Backend Capsule](../../.gitbook/assets/creating-backend-capsule-2.gif)
...
![Backend Capsule Build Logs](../../.gitbook/assets/backend-capsule-build-logs-2.gif)
...
![Backend Capsule Details](../../.gitbook/assets/backend-capsule-tabs-2.gif)
...
![Node.js Express Backend Capsule Details](../../.gitbook/assets/express-backend-capsule.png)
...
![Teams, Spaces and Capsules](<../../.gitbook/assets/teamspacecapsule (1).png>)
...
![Team Management](../../.gitbook/assets/team-tabs-2.gif)
