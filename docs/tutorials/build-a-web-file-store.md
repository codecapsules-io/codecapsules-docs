...
description: >-
  Create a cloud application with persistent data storage that you can easily
  access from your devices.
---

# Building a Web File Store

![Building Web file store Cover](../../.gitbook/assets/web_file_store.png)
...
![Bind data capsule](<../../.gitbook/assets/bind-persistent (2).png>)
...
![Storage path environment variable](<../../.gitbook/assets/env-variables-persistent-storage (1).png>)
...
![Unpopulated file list](../../.gitbook/assets/blank-files.png)
...
![upload file](../../.gitbook/assets/upload-section.png)
...
![Downloading a file](../../.gitbook/assets/download-file.png)
...
![Deleting a file](../../.gitbook/assets/file-delete.png)
...
![Username and password environment variables](../../.gitbook/assets/username-env.png)
...
![Authentication page](../../.gitbook/assets/auth.png)
