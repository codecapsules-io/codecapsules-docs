...
![Game Catalogue Cover](../../.gitbook/assets/game-catalogue-cover.jpg)
...
![Setup run command](../../.gitbook/assets/run-command-setup.png)
...
![setup database logs](../../.gitbook/assets/setup-logs.png)
...
![empty get route](../../.gitbook/assets/get-results.png)
...
![Post new game](../../.gitbook/assets/post-game.png)
...
![Put method with Postman](../../.gitbook/assets/put-game.png)
...
![Delete a record](../../.gitbook/assets/delete-game.png)
...
![Adding username and password](../../.gitbook/assets/env-user-password.png)
...
![Authentication error](../../.gitbook/assets/auth-error.png)
...
![Postman Auth Settings](../../.gitbook/assets/auth-settings.png)

If you try your query again, it should let you pass, and come back with the usual response.

![Authentication success](../../.gitbook/assets/auth-success.png)
