...
description: >-
  Learn how to build a Telegram bot in Node.js that responds with current
  Ethereum prices and host it on Code Capsules
---

# Create and Host a Telegram Bot with Node.js on Code Capsules

![Creating a telegram bot with Node.js cover](../../.gitbook/assets/telegrambot.jpg)
...
![Bot conversation](../../assets/tutorials/create-telegram-bot-nodejs/conversation.jpg)
...
![Bot token environment variable](../../.gitbook/assets/env-var.png)
