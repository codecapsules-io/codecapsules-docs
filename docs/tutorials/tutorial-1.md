...
![image2](../assets/tutorial-1/Image2.png)
...
- Remove pagination
    ![pagination](../assets/tutorial-1/pagination.png)
...
- Copy the URL given to you under "Quick setup".
    ...
    ![image10](../assets/tutorial-1/image10.png)
...
![image11](../assets/tutorial-1/image11.png)
...
![team](../assets/tutorial-1/team.png)
...
![GitHubButton](../assets/tutorial-1/github_button.png)
...
5. Press "Install & Authorize".
    ...
    ![permissions_git](../assets/tutorial-1/permissions_git.png)
...
4. Leave the build command blank and enter the name of the sub-directory containing the portfolio files in the "Static Content Folder Path" entry box.
  ...
  ![Creating a capsule](../assets/tutorial-1/new_capsule.gif)
...
![image15](../assets/tutorial-1/image15.png)

## Conclusion and Further Reading

![finished_port](../assets/tutorial-1/finished_port.png)
