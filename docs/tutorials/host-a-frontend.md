...
description: >-
  Build and personalize your portfolio to showcase your skills in a unique way.
  Take a look at how to deploy the end product to Code Capsules.
---

# Host your front-end developer portfolio

![Portfolio Cover Image](../../.gitbook/assets/portfolio-1.jpg)
...
![image2](../../.gitbook/assets/starter_template.png)
...
* Remove pagination![pagination](../../.gitbook/assets/pagination.png)
...
If you already know how to push code from a local repository to a remote repository on GitHub, push the **sub-directory** containing the portfolio to GitHub and [skip](host-a-frontend.md#deploying-to-code-capsules) to the next section.
...
*   Copy the URL given to you under "Quick setup".
    ...
    ![image10](../../.gitbook/assets/image10.png)_Locate the link to your repository under "Quick Setup"_
...
Replace the URL above with the URL to your remote repository (copied in the [previous](host-a-frontend.md#creating-the-remote-repository) section).
...
![image11](../../.gitbook/assets/image11.png)
...
![finished\_port](../../.gitbook/assets/finished_port.png)
