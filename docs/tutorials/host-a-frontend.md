...
In this tutorial, we'll create a front-end, which is content that visitors see when they load your website. We can use Code Capsules to host a simple portfolio website for free. Code Capsules is a service that hosts front-end (and back-end) code online. 
