...
description: >-
  Take a look at how to customise your application's default Code Capsules
  domain to a personal one tailored to your app's purpose.
---

# Customising Your Domain on Code Capsules

![Customising Domain Cover](../../.gitbook/assets/customising-domain-cover.jpg)
...
![image3](../../.gitbook/assets/image3.png)
...
8.  Choose "Permanent" under **Type of web forwarding**
    ...
    ![image4](../../.gitbook/assets/image4.png)
...
6. Type your default Code Capsules web-application URL under **Hostname** (find this in the "Overview" tab in your web-application's Capsule), with a period at the end. It should look like the below:![image2](../../.gitbook/assets/image2.png)
7. Click create.
