...
To demonstrate how to deploy a Flask MongoDB application with Code Capsules, we’ve provided an example application which you can find on the [Code Capsules GitHub repository]().
...
![Bind MERN Capsules](../assets/deployment/flask/bind-flask-mongo.png)
...
![Deployed App](../assets/deployment/flask/flask-pymongo-app.png)
