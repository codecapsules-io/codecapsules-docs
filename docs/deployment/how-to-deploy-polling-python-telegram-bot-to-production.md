...
_This guide uses polling, which is easier to deploy but not recommended. See_ [_this guide_](how-to-deploy-python-telegram-bot-to-production.md) _for how to implement the same bot using webhooks._
