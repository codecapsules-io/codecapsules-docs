---
title: Deploy a Next.js and Mongo Application
...
To demonstrate how to deploy [a/an framework/language] application with Code Capsules, we’ve provided an example application which you can find on the [Code Capsules GitHub repository](insert link).
...
![Bind MERN Capsules](../assets/deployment/next/bind-next-mongo.png)
