---
title: Deploy an HTML5up Template to Production
description: A walkthrough on how to deploy an HTML5up Template from GitHub.
---

# How to Deploy an HTML5up Template to Production on Code Capsules

Deploy an HTML5up template and learn how to host frontend code on Code Capsules. 

## Set up

Code Capsules connects to GitHub repositories to deploy applications. To follow this guide, you’ll need a [Code Capsules](https://codecapsules.io/) account and a [GitHub](https://github.com/) account.

To demonstrate how to deploy an HTML5up template to Code Capsules, head over to [HTML5up](https://html5up.net/) and download the zip file for any template that you like. Unzip this template file in your preferred working directory on your local machine.

## Create a Repository

Sign in to GitHub and create a repository for the template site you downloaded. You need to push the unzipped template files to your newly created repository for Code Capsules to deploy the template site from your GitHub account. To do this, initialize a git repository in the project's root folder on your machine by running the command `git init` from a terminal window while in the root folder. 
...
Run the command below to set the remote repository for your local repo and make sure to replace `<YOUR-REMOTE-GITHUB-URL>` with the actual url for your remote repository. 
