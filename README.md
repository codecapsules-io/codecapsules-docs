...
docker run -p 5555:5555 -d eu.gcr.io/appstrax/code-capsules-docs:1.0.32

# Building and Deploying

docker build -t eu.gcr.io/appstrax/code-capsules-docs:1.0.32 .

docker push eu.gcr.io/appstrax/code-capsules-docs:1.0.32
