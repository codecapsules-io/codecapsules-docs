...
docker run -p 5555:5555 -d eu.gcr.io/appstrax/code-capsules-docs:1.0.37

# Building and Deploying

docker build -t eu.gcr.io/appstrax/code-capsules-docs:1.0.37 .

docker push eu.gcr.io/appstrax/code-capsules-docs:1.0.37
